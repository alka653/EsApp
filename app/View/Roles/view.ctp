...
<h2><?php echo __('Role'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Name Role'); ?></dt>
		<dd>
			<?php echo h($role['Role']['name_role']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('State'); ?></dt>
		<dd>
			<?php echo $this->Html->link($role['State']['id'], array('controller' => 'states', 'action' => 'view', $role['State']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
</div>
